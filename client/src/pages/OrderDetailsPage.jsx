      ...
      {!orderDetails ? (
        ...
        <div className="p-4 sm:p-6 rounded-lg border">
          ...
          <div className="flex flex-col sm:flex-row justify-between mb-8">
            ...
            <div className="flex flex-col items-start sm:items-end mb-4 sm:mt-0">
              <span
                className={`${
                  orderDetails.isPaid
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
            {/* Customer Info */}
            <div>
              <h4 className="font-semibold mb-2 text-lg">Payment Info</h4>
              <p className="">Payment Method : {orderDetails.paymentMethod} </p>
              <p>Status: {orderDetails.isPaid ? "Paid" : "Unpaid"} </p>
            </div>
            <div>
              <h4 className="font-semibold mb-2 text-lg">Shipping Info</h4>
              <p className="">
